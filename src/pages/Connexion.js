        ...
        <div class= "w-100 h-100 d-flex align-items-center justify-content-center">
            <div class=" col-xl-4 col-lg-5 col-md-6 col-sm-7 col-12 p-5" style={{ backgroundColor:"rgba(43, 43, 43,0.6)", borderRadius:20}}> 
                <div class="px-lg-4">
                    ...
                    <h3 class= "my-4" style={{color: "white"}}>Login</h3>
                    ...
                    <a href='#' style={{fontSize: 13 ,color: "white", textDecoration:"none" }}>Forgot password ?</a>

                    <div class="form-group my-4 text-center">
                        <div class="col-sm-12">
                            <button type="submit" class="btn w-100" style={{fontWeight:"bold", backgroundColor: "rgb(0, 255, 153)", color: "#181C20"}}>Login</button>
                        </div>
                        <div class="mt-3">
                    ...
                    <div class="form-group mt-4 text-center">
                        <div class="mt-3">
                            <h10 style={{color: "white", fontSize:14}}>Don't have an account : </h10>
                            <Link to='/inscription' style={{fontSize: 13 ,color: "white", textDecoration:"none", fontWeight:"bold" }}>Create account </Link>
                        </div>
                    </div>
                </div>
            </div>
